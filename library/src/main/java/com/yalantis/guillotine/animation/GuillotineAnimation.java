...
//        setUpOpeningView(builder.openingView);
    ...
    public void setUpOpeningView(final View openingView) {
    ...
    public static class GuillotineBuilder {
        ...
        private final View chooseView1;

        private boolean isClosedOnStart;

        public GuillotineBuilder(View guillotineView, View closingView, View openingView, View chooseView1) {
            this.guillotineView = guillotineView;
            this.openingView = openingView;
            this.closingView = closingView;

            this.chooseView1 = chooseView1;
        }
